...
/***/ function(module, exports, __webpack_require__) {
	...
	var labels = __webpack_require__(2);
...
/***/ function(module, exports) {
	...
	var phpOrigin = 'backend/requestHandler.php';
	var formId = '123';
	var replyId = '245';
	//adding a selector works only for a single entry!
	var selector = undefined;
	//var selector = {"supervisor" :"MichaelMartin"};
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(6)(window, jQuery);
	var showform = function showform(pathToPhpHandler, formId, replyDivId, labels, selector) {
	    ...
	    form.done(function (form) {
	        ...
	        for (var i = 0; i < form.length; i++) {
	            if (form[i].options.length == 1) {
	                ...
	                output += "<input type=\"hidden\" id=\"" + form[i].id + "\"value=\"" + form[i].options[0].value + "\">\n";
	            } else {
	                ...
	                for (var j = 0; j < form[i].options.length; j++) {
	                    output += "<option value=\"" + form[i].options[j].value + "\">" + findLabel(form[i].options[j].label, labels) + "</option>\n";
	                }
	                output += "</select></td></tr>\n";
	            }
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};/*! DataTables 1.10.12
	...
	define(['jquery'],function($){return factory($,window,document);});}else if(( false?'undefined':_typeof(exports))==='object'){// CommonJS
	...
	__webpack_require__(4):__webpack_require__(4)(root);}return factory($,root,root.document);};}else{// Browser
	...
	return iThis>iThat;}return true;};/**
		 ...
		 *      $('#example').dataTable();
		 *    }
		 */DataTable.isDataTable=DataTable.fnIsDataTable=function(table){var t=$(table).get(0);var is=false;$.each(DataTable.settings,function(i,o){var head=o.nScrollHead?$('table',o.nScrollHead)[0]:null;var foot=o.nScrollFoot?$('table',o.nScrollFoot)[0]:null;if(o.nTable===t||head===t||foot===t){is=true;}});return is;};/**
	...
	if(isNaN(flo)){return __htmlEscapeEntities(d);}d=Math.abs(flo);var intPart=parseInt(d,10);var floatPart=precision?decimal+(d-intPart).toFixed(precision).substring(2):'';return negative+(prefix||'')+intPart.toString().replace(/\B(?=(\d{3})+(?!\d))/g,thousands)+floatPart+(postfix||'');}};},text:function text(){return{display:__htmlEscapeEntities};}};/*
